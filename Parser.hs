...
-- Try to parse a file
-- Nimmt einen Dateipfad und versucht die Datei zu lesen und übergibt diese dann der Funktion parse
-- welche für Programme und Goals definiert ist, diese "liest sie dann ein"
-- geht dabei etwas schief wird eine Fehlermeldung ausgegeben
